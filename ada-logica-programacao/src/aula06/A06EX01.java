...
public class A06EX01 {
    ...
    Cada estado possui uma taxa diferente de imposto sobre o produto (MG 7%; SP 12%; RJ 15%;).
    Faça um programa que recebe o valor do produto e o estado de destino do produto e,
    então, calcule o preço final do produto acrescido do imposto baseado no estado em que ele será vendido.
